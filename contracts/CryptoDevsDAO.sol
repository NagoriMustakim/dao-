...
contract CryptoDevsDAO is Ownable {
    struct Proposal {
        uint256 yayVotes; //favor vote
        uint256 nayVotes; //against vote
        bool executed; //status
        uint256 deadline; //deadline of proposal
        uint256 nftTokenId; // tokenid for purchasing nft form nft marketplace
        mapping(uint256 => bool) voters; // nft to vote
    }
    enum Vote {
        YAY, // YAY = 0
        NAY // NAY = 1
